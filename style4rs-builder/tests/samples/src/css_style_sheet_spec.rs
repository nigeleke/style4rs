...
#[test]
pub fn basic() {
    let (class_name, style) = style_sheet_str!("style4rs-builder/tests/samples/src/samples/basics.css");
...
#[test]
pub fn relation() {
    let (class_name, style) = style_sheet_str!("style4rs-builder/tests/samples/src/samples/relations.css");
    ...
    let expected = format!(r#"div.{}>p.{}{{background-color:#ff0}}div.{}+p.{}{{background-color:#ff0}}p.{}~ul.{}{{background:red}}a[target].{}{{background-color:#ff0}}a[title="I am ,testing"].{}{{background-color:#ff0}}[title~=flower].{}{{background-color:#ff0}}[lang|=en].{}{{background-color:#ff0}}div[class^=test].{}{{background-color:#ff0}}div[class$=test].{}{{background-color:#ff0}}div.{} [class$=test].{}{{background-color:#ff0}}div[class*=test].{}{{background-color:#ff0}}"#,
        class_name, class_name, class_name, class_name, class_name, 
        class_name, class_name, class_name, class_name, class_name,
        class_name, class_`name, class_name, class_name, class_name);
...
fn pseudo() {
    ...
    let (class_name, style) = style_sheet_str!("style4rs-builder/tests/samples/src/samples/pseudo.css");
...
fn at_rules() {
    ...
    //
    let (class_name, style) = style_sheet_str!("style4rs-builder/tests/samples/src/samples/at_rules.css");
...
#[test]
fn special_at_rules() {
    let (_, style) = style_sheet_str!("style4rs-builder/tests/samples/src/samples/special_at_rules.css");
...
fn custom_pseudo_class() {
    let (class_name, style) = style_sheet_str!("style4rs-builder/tests/samples/src/samples/custom_pseudo.css");
