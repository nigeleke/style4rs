...
#[test]
pub fn basic() {
    let (class_name, style) = style_sheet_str!("style4rs/tests/samples/basics.css");
...
#[test]
pub fn relation() {
    let (class_name, style) = style_sheet_str!("style4rs/tests/samples/relations.css");
...
fn pseudo() {
    ...
    let (class_name, style) = style_sheet_str!("style4rs/tests/samples/pseudo.css");
...
fn at_rules() {
    ...
    //
    let (class_name, style) = style_sheet_str!("style4rs/tests/samples/at_rules.css");
...
#[test]
fn special_at_rules() {
    let (_, style) = style_sheet_str!("style4rs/tests/samples/special_at_rules.css");
...
fn custom_pseudo_class() {
    let (class_name, style) = style_sheet_str!("style4rs/tests/samples/custom_pseudo.css");
